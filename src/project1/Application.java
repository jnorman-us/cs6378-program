package project1;//project1.Application to detect whether a given topology is a ring topology
...
public class Application implements Listener
{
	...
	//invoked by node.Node class when it receives a message
	...
	public synchronized void run()
	{
		...
		//node.Node 0 initiates ring detection algorithm
		if(myID.getID() == 0)
		{
			if(detectRing())
			{
